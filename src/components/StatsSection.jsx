  ...
  const stats = [
    {
      ...
      value: "25",
      suffix: "k+",
      label: { en: "Funds and syndicates", ar: "الصناديق والتحالفات" },
    },
    {
      id: 2,
      value: "13",
      suffix: "k+",
      label: { en: "Active startups", ar: "الشركات الناشئة النشطة" },
    },
    {
      id: 3,
      value: "72",
      suffix: "k+",
      label: { en: "Active investors", ar: "المستثمرون النشطون" },
    },
    {
      id: 4,
      value: "10.7",
      prefix: "$",
      suffix: "B",
      label: { en: "Raised by active startups", ar: "بالأرقام" },
    },
  ];
      ...
      <div className="mx-auto max-w-[1600px] px-6 lg:px-12 w-full grid lg:grid-cols-2 gap-16 lg:gap-32 items-start">
        ...
        <div className="space-y-12">
          <div className="space-y-6">
            <motion.p
              animate={{
                color: isInView ? "rgba(255,255,255,0.6)" : "var(--text-muted)",
              }}
              className="text-xs uppercase tracking-[0.2em] font-[Metropolis]"
            >
            ...
            <p className="text-lg md:text-xl lg:text-2xl font-[Metropolis] leading-relaxed max-w-xl opacity-80">
              <BilingualText
          ...
          <div className="relative group max-w-md aspect-[4/3] rounded-sm overflow-hidden bg-black/10 border border-white/10 p-10 flex flex-col justify-end">
            ...
            <div className="relative z-10 space-y-4">
              <h3 className="text-2xl font-normal leading-tight">
                <BilingualText
                  en="THE FUND BENCHMARKS REPORT 2025"
                  ar="تقرير معايير الصناديق 2025"
                />
              </h3>
              <div className="h-px w-12 bg-white/40" />
              <button className="text-sm uppercase font-[Metropolis] tracking-widest font-medium opacity-60 group-hover:opacity-100 transition-opacity">
                Data
              </button>
            </div>
            ...
            <div className="absolute top-0 right-0 w-1/2 h-full opacity-30 pointer-events-none">
              <svg viewBox="0 0 200 200" className="w-full h-full">
                <path
                  d="M0 150 Q50 120 100 140 T200 110"
                  fill="none"
                  stroke="white"
                  strokeWidth="0.5"
                />
                <path
                  d="M0 160 Q60 130 110 150 T200 120"
                  fill="none"
                  stroke="white"
                  strokeWidth="0.5"
                />
          ...
          <div className="grid grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-12 lg:gap-y-16 border-t border-white/20 pt-16">
            {stats.map((stat) => (
              <div key={stat.id} className="space-y-4">
                <div className="text-4xl md:text-6xl lg:text-7xl font-[Metropolis] tracking-tighter">
                  <AnimatedCounter
                    value={stat.value}
                    prefix={stat.prefix}
                    suffix={stat.suffix}
