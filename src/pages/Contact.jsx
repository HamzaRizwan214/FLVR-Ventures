      ...
      <div className="flex flex-col lg:flex-row w-full min-h-[90vh]">
        ...
        <section className="w-full lg:w-1/2 flex flex-col justify-center px-6 lg:px-24 py-12 lg:py-0 border-b lg:border-b-0 lg:border-r border-[var(--border-default)]">
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl text-[var(--text-secondary)] leading-relaxed mb-12 max-w-xl"
          >
            <BilingualText
          ...
          >
            <div className="pb-6 border-b border-[var(--border-default)]">
              <h3 className="text-xl font-normal text-[var(--brand-primary)] mb-2">
                <BilingualText
              ...
              <a
                ...
                className="group inline-flex items-center text-2xl text-[var(--text-primary)] hover:text-[var(--brand-accent)] transition-colors"
              >
        ...
        <section className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 lg:px-24 py-12 lg:py-0 bg-[var(--bg-secondary)] relative overflow-hidden">
          ...
          >
            ...
            <h2 className="text-3xl font-normal tracking-tight text-center text-[var(--text-primary)] mb-4">
              <BilingualText
            ...
            <button className="w-full py-4 bg-[var(--brand-primary)] hover:bg-[var(--text-link)] text-white text-lg font-normal rounded-2xl transition-all shadow-[0_10px_20px_rgba(11,114,133,0.2)] hover:shadow-[0_15px_25px_rgba(11,114,133,0.4)] hover:-translate-y-1">
